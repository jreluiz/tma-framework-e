...
public class DockerActuatorPerformance implements Actuator {

    private static final Logger LOGGER = LoggerFactory.getLogger(DockerActuatorPerformance.class);
    ...
    public void act(@RequestBody ActuatorPayload actuatorPayload) {
		...
		Jep jep = new Jep(false,
				"/home/jorge/workspace/sts/tma-framework-e/development/actuators/demo-actuator-java/src/main/java/eubr/atmosphere/tma/actuator/docker-stats-actuator.py")) {
			jep.runScript("docker-stats-actuator.py");
